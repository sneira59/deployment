...
@section('p')
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Servidores</h2></h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <span class="breadcrumb-item active">Nuevo Servidor</span>
                            </nav>
                        </div>
                    </div>
                    <div class="card">
                            ...
                            <form action="{{route('servidores.store')}}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="s"><sup class="obligatorio">*</sup>Numero del servidor</label>
                                        <input type="text" class="form-control" name="s" id="s"
                                               placeholder="Servidor" value="{{old('s')}}">
