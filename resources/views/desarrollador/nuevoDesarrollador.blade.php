...
@section('p')
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Desarrollador</h2></h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <span class="breadcrumb-item active">Nuevo Desarrollador</span>
                            </nav>
                        </div>
                    </div>
                    <div class="card">
                            ...
                            <form action="{{route('desarrolladores.store')}}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="nd"><sup class="obligatorio">*</sup>Nombre del Desarrollador</label>
                                        <input type="text" class="form-control" name="nd" id="nd"
                                               placeholder="Desarrollador" value="{{old('nd')}}">
