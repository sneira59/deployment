                    ...
                    <div class="page-header">
                        ...
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <span class="breadcrumb-item active">Editar ambiente</span>
                            </nav>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url('ambientes/'.$ambiente->idAmbiente)}}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="ambiente" id="ambiente"
                                               placeholder="Ambiente" value="{{$ambiente->nomb_amb}}">
