...
@section('p')
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Ramas</h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <span class="breadcrumb-item active">Editar Rama</span>
                            </nav>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url('ramas/'.$rama->idRama)}}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="r"><sup class="obligatorio">*</sup>Ramas</label>
                                        <input type="text" class="form-control" name="r" id="r"
                                               placeholder="Devops" value="{{$rama->nomb_rama}}">
